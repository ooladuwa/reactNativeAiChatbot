...
const features = () => {
  return (
    <View style={{ height: hp(60) }} className="mb-4">
      ...
      <View className="mb-4 rounded-xl bg-emerald-200 p-4">
        ...
        >
          ChatGPT can provide you with instant and knowledgeable responses and
          assist you with creative ideas on a wide range of topics.
        </Text>
      </View>
      <View className="mb-4 rounded-xl bg-purple-200 p-4">
        <View className="flex-row items-center">
          <Image
            style={{ width: wp(8), height: hp(4) }}
            source={require('../../assets/images/chatgpt-icon.png')}
        ...
        >
          ...
          descriptions expanding the boundaries of visual creation.
        </Text>
      </View>
      <View className="mb-4 rounded-xl bg-cyan-200 p-4">
        <View className="flex-row items-center">
          <Image
            style={{ width: wp(8), height: hp(4) }}
            source={require('../../assets/images/chatgpt-icon.png')}
